...
const TheLastDance: NextPage = () => {
    ...
    function onClickPlay() {
        window.open("https://photos.app.goo.gl/SpmPvb81NxYiCnyy7", "_blank");
    }
                    ...
                    <div className={styles.page}>
                        <div className={styles.enterance}>
                            ...
                            <div className={styles.content}>
                                ...
                                <div className={styles.buttons}>
                                    <div className={styles.play} onClick={onClickPlay}>
                                    ...
                                    <div className={styles.info} onClick={onClickPlay}>
